...
import { approveMembership } from "@/lib/groups/groups";
import { MembershipNotFoundError, GroupMemberLimitReachedError } from "@/lib/groups/errors";
...
export async function POST(request: NextRequest, { params }: RouteContext) {
  ...
  try {
    const membership = await approveMembership(id, userId);
